...
#define RESP_12MA_Pin GPIO_PIN_9
#define RESP_12MA_GPIO_Port GPIOE
#define RESP_24MA_Pin GPIO_PIN_11
#define RESP_24MA_GPIO_Port GPIOE
#define RST_Pin GPIO_PIN_13
#define RST_GPIO_Port GPIOE
#define CHSEL_Pin GPIO_PIN_9
#define CHSEL_GPIO_Port GPIOC
...
#define ADC_BUFFER_SIZE 5  //128     // Number of ADC samples to capture (changed from 100 to 128)
